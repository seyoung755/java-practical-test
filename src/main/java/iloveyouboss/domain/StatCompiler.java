...
public class StatCompiler {
    ...
    private Map<String, Map<Boolean, AtomicInteger>>
            convertHistogramIdsToText(
    ...
    convertHistogramIdsToText(
            Map<Integer, Map<Boolean, AtomicInteger>> responses) {
        Map<String, Map<Boolean, AtomicInteger>> textReponses = new HashMap<>();
        responses.keySet().stream().forEach(id ->
                textReponses.put(controller.find(id).getText(),
                        responses.get(id)));
        return textReponses;
    }
